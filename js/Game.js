class Game {
        ...
        displayRanks(){
          ...
          imageMode(CENTER)
          Player.getPlayerInfo()
          image(b_image , displayWidth/-4 , -100+displayHeight/9 , 200 , 240) 
          image(g_image , 0 , -100 , 250 , 300) 
          image(s_image , displayWidth/4 , -100+displayHeight/9 , 225 , 270) 
          textAlign(CENTER)
          textSize(50)
          for(var plr in allPlayers){
            if(allPlayers[plr].place===1){
              ...
              textSize(30)
              text("honorableMansion"+ allPlayers[plr].name , 0 , 225)
            }
